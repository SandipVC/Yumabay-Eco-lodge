...
export const TEXT_SECTIONS = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'blocked', label: 'Blocked status', kind: 'text' },
      { key: 'downloadPlan', label: 'Download Plan button', kind: 'text' },
      { key: 'unit', label: 'Unit label', kind: 'text' },
      { key: 'type', label: 'Type label', kind: 'text' },
      { key: 'level', label: 'Level label', kind: 'text' },
      { key: 'internalArea', label: 'Internal Area label', kind: 'text' },
      { key: 'balcony', label: 'Balcony label', kind: 'text' },
      { key: 'totalArea', label: 'Total Area label', kind: 'text' },
      { key: 'areaRange', label: 'Area Range label', kind: 'text' },
      { key: 'area', label: 'Area label', kind: 'text' },
      { key: 'totalUnits', label: 'Total Units label', kind: 'text' },
      { key: 'clickCompare', label: 'Compare navigation hint', kind: 'text' },
      { key: 'interactiveTitle', label: 'Interactive plan title', kind: 'text' },
      { key: 'interactiveDesc', label: 'Interactive plan description', kind: 'textarea' },
      { key: 'sharedAmenity', label: 'Shared amenity description', kind: 'textarea' },
      { key: 'villasPlan', label: 'Villas Plan button', kind: 'text' },
      { key: 'downloadBrochure', label: 'Download Brochure button', kind: 'text' },
      { key: 'downloadAmenities', label: 'Download Amenities button', kind: 'text' },
      { key: 'enquiry', label: 'Enquiry title', kind: 'text' },
      { key: 'cancel', label: 'Cancel button', kind: 'text' },
      { key: 'back', label: 'Back button', kind: 'text' },
      { key: 'clickAnyZone', label: 'SVG click hint', kind: 'text' },
    ],
  },
  {
    id: 'footer',
    ...
    fields: [
      ...
      { key: 'whatsappWidgetTitle', label: 'WhatsApp Popup Title', kind: 'text' },
      { key: 'whatsappWidgetSub', label: 'WhatsApp Popup Subtitle', kind: 'text' },
      { key: 'whatsappOp1Name', label: 'WhatsApp Option 1 Name', kind: 'text' },
      { key: 'whatsappOp1Url', label: 'WhatsApp Option 1 URL', kind: 'text' },
      { key: 'whatsappOp2Name', label: 'WhatsApp Option 2 Name', kind: 'text' },
      { key: 'whatsappOp2Url', label: 'WhatsApp Option 2 URL', kind: 'text' },
