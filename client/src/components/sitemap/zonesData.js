...
export const ZONE_DEFAULTS = [
  { id: 'villa-tipo-1',  label: 'Villa Tipo 1',   type: 'Villa',                 phase: 1, availability: 'limited',   beds: '3 Bedrooms',         area: '222 m²',     price: 'From $280,000', units: 12, icon: '🏡', x: 52,  y: 280, w: 120, h: 88 },
  { id: 'building-a',    label: 'Building A',      type: 'Apartments',            phase: 1, availability: 'available',  beds: 'Studio – 3BR',       area: 'Various',    price: 'From $95,000',  units: 24, icon: '🏢', x: 200, y: 160, w: 90,  h: 110 },
  { id: 'building-b',    label: 'Building B',      type: 'Apartments',            phase: 1, availability: 'available',  beds: 'Studio – 3BR',       area: 'Various',    price: 'From $95,000',  units: 24, icon: '🏢', x: 304, y: 160, w: 90,  h: 110 },
  { id: 'building-c',    label: 'Building C',      type: 'Apartments',            phase: 1, availability: 'available',  beds: 'Studio – 3BR',       area: 'Various',    price: 'From $95,000',  units: 20, icon: '🏢', x: 408, y: 160, w: 90,  h: 110 },
  { id: 'building-d',    label: 'Building D',      type: 'Apartments + Penthouse', phase: 1, availability: 'limited',   beds: '1–3BR + Penthouse', area: 'Various',    price: 'From $110,000', units: 18, icon: '🏢', x: 512, y: 160, w: 90,  h: 110 },
  { id: 'building-e',    label: 'Building E',      type: 'Apartments',            phase: 2, availability: 'available',  beds: 'Studio – 2BR',       area: 'Various',    price: 'From $95,000',  units: 18, icon: '🏢', x: 616, y: 160, w: 90,  h: 110 },
  { id: 'bungalows',     label: 'Bungalows',       type: 'Beachfront Bungalows',  phase: 2, availability: 'available',  beds: '1–2 Bedrooms',       area: '85–120 m²',  price: 'From $150,000', units: 16, icon: '🛖', x: 196, y: 290, w: 200, h: 78 },
